...
public class Tag {
	...
	public static class Builder {
		 ...
		 * @param name
		 *            - tag name
		 * @return tag {@link Builder} with name <var>name</var>
		 */
		...
		/**
		 * Returns a tag {@link Builder} to build a {@link Tag} with the name
		 * <var>name</var> and owner <var>owner</var>
		 * 
		 * @param name
		 *            - the tag name
		 * @param owner
		 *            - the tag owner id
		 * @return A {@link Builder} with name set to <var>name</var> and owner id
		 *         set to <var>owner</var>
		 */
		 ...
		 * @return tag {@link Builder} with owner set to <var>owner</var>
		 */
